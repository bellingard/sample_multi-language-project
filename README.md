...
[![Build status](https://staging.travis-ci.org/FabOrga/multi-language-project.svg?branch=master)](https://staging.travis-ci.org/FabOrga/multi-language-project) [![Quality Gate](https://sonarqube.com/api/badges/gate?key=test:multi-language-project)](https://sonarqube.com/dashboard/index/test:multi-language-project)
